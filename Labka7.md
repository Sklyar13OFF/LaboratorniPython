...
Введіть значення для елемента в 0 рядку та 0 стовпці1

Введіть значення для елемента в 0 рядку та 1 стовпці2

Введіть значення для елемента в 0 рядку та 2 стовпці3

Введіть значення для елемента в 0 рядку та 3 стовпці4

Введіть значення для елемента в 1 рядку та 0 стовпці5

Введіть значення для елемента в 1 рядку та 1 стовпці6

Введіть значення для елемента в 1 рядку та 2 стовпці7

Введіть значення для елемента в 1 рядку та 3 стовпці8

Введіть значення для елемента в 2 рядку та 0 стовпці9

Введіть значення для елемента в 2 рядку та 1 стовпці7

Введіть значення для елемента в 2 рядку та 2 стовпці1

Введіть значення для елемента в 2 рядку та 3 стовпці2

Транспонована матриця виглядатиме - [[1.0, 5.0, 9.0], [2.0, 6.0, 7.0], [3.0, 7.0, 1.0], [4.0, 8.0, 2.0]]
